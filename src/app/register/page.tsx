        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-10 sm:py-12">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-5xl bg-white rounded-3xl shadow-xl shadow-emerald-100/50 overflow-hidden grid md:grid-cols-2 border border-emerald-100">
                ...
                <div className="hidden md:flex bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 p-10 flex-col justify-center items-center text-white relative overflow-hidden">
                    ...
                    <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="text-2xl sm:text-3xl font-extrabold mb-4">Join WanderPlan</motion.h2>
                ...
                <div className="p-8 sm:p-10 md:p-12">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="mt-6 space-y-3">
                        ...
                        <a href="https://wanderplan-ai-back.vercel.app/api/auth/google/redirect" className="w-full py-3 border border-gray-300 rounded-2xl flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors text-gray-700 font-medium">
