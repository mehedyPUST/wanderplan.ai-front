                ...
                <div className="max-w-5xl mx-auto px-4 py-12 mt-16">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            ...
                            <p className="text-emerald-100 mt-2">{itineraries?.length || 0} trip plans</p>
                        </div>
            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                {isLoading ? (
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-16">
                        ...
                        <p className="text-gray-400 mb-6">Create your first trip plan!</p>
                                ...
                                <div className="flex flex-col sm:flex-row justify-between gap-4">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                                            ...
                                            <span className="flex items-center gap-1">
                                                <FaDollarSign className="text-amber-500" /> ${item.budget || 0}
                                            </span>
                                            {item.createdAt && (
